...
- **Data Warehouse & Business Intelligence, Porsche Bank Group** - complex SQL queries, SQL view optimization, ETL flow analysis, data validation, reporting support, and data quality work in an automotive finance environment
...
- **Enterprise & Workflow:** SAP technologies, Kanban, Jira, Confluence, technical business processes
